...
export default function AddOrderModal({ initialData, onClose, onFinalize }) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
            <div className="bg-[#1e293b] text-white rounded-xl shadow-2xl w-full max-w-lg p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button
                            ...
                            disabled={initialData.components.length !== 8} 
                        >
                ...
                {initialData.components.length !== 8 && (
                    <p className="text-red-400 text-sm mt-2">Você deve selecionar todos os 8 componentes para finalizar o pedido.</p>
                )}
            </div>
        </div>
    );
