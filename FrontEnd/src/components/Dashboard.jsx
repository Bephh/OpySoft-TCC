...
import OrdemDeServico from '../pages/OS'; // Importa a nova página de Ordem de Serviço
import Clientes from '../pages/Clientes'; // Importa a nova página de Clientes
...
export default function DashBoard() {
  ...
  const OrdemDeServicoComponent = SafeImport(OrdemDeServico, 'OrdemDeServico'); // Mapeia o componente OrdemDeServico
  const ClientesComponent = SafeImport(Clientes, 'Clientes'); // Mapeia o componente Clientes
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'Ordem de Serviço': // Nova aba de Ordem de Serviço
        return <OrdemDeServicoComponent />;
      case 'Clientes': // Nova aba de Clientes
