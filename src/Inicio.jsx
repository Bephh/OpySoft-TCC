  ...
  return (
    <div className="bg-gray-900 text-gray-100 font-sans flex flex-col min-h-screen">
      ...
      <header className="absolute top-0 left-0 w-full z-20 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg text-white">
            Vanguard<span className="text-red-500">Tech</span>
          </span>
        </div>

        <nav className="hidden md:flex gap-6 text-white">
          <a href="#" className="hover:text-red-400 transition">Home</a>
          <a href="#sobre" className="hover:text-red-400 transition">Sobre</a>
          <a href="#beneficios" className="hover:text-red-400 transition">Benefícios</a>
      ...
      >
        ...
        <div className="relative p-6 text-center max-w-md md:max-w-xl mx-auto z-10">
          <p className="text-gray-200 mb-8 text-2xl md:text-4xl font-bold leading-snug">
            Transforme sua empresa de manutenção de hardware com o VanguardTech ERP. <br /><span className="text-red-500">Teste gratuito agora!</span>
          </p>
          <button className="cursor-pointer bg-red-500 hover:bg-red-600 text-white font-semibold px-9 py-5 rounded-lg shadow-md transition mb-4">
      ...
      <section id="beneficios" className="py-16 px-6 bg-gray-950 flex-1">
        <h2 className="text-3xl font-bold text-center mb-10 text-white">Por que o VanguardTech?</h2>
      ...
      <footer id="contato" className="bg-gray-950 text-gray-400 py-6 mt-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm">
            © {new Date().getFullYear()} VanguardTech. Todos os direitos reservados.
          </p>
